    ...
    return (
      <div>
        <div className="splash-container">
          <Carousel>
            <Carousel.Item>
              <iframe width={1000} height={520} alt="900x500" src="https://www.twitch.tv/ninja" />
              <Carousel.Caption>
                <h3>Ninja</h3>
                <p>FFXI all night - Nasomi server | All merch and apparel at Teamninja.com | Ninja on ALL social medias</p>
              </Carousel.Caption>
            </Carousel.Item>
            <Carousel.Item>
